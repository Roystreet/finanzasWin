...
@section('title', 'PQRS')
                                ...
                                <div class="row contenedor">
                                    ...
                                    <form class="caja col-lg-7 form-horizontal" action="#" id="formfreshdeks" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-10 card" style="margin: 0 auto; padding-top: 2rem;">
                                            ...
                                            <div class="form-group" >
                                                <label class="col-sm-12 text-bold" for="agent">Agente quien reporta <i class="fa fa-question-circle" title="Ingrese el usuario con lo cual se registro en la aplicación u oficina virtual."></i></label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="agent" name="agent" placeholder="Ingrese su nombre" >
        ...
        <script src="{{ asset('js/Reclamaciones/incidencias.js')}} "></script>
