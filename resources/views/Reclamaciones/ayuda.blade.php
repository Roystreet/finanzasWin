...
@section('title', 'PQRS')
                                ...
                                <div class="row contenedor">
                                    ...
                                    <form class="caja col-lg-7 form-horizontal" action="#" id="formfreshdeks" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-10 card" style="margin: 0 auto; padding-top: 2rem;">
                                            ...
                                            <!-- Asunto inicio -->
                                            <div class="form-group  justify-content-md-center">
                                                <label class="col-sm-12 text-bold" for="pwd"> Elija la categoría del incidente <i class="fa fa-question-circle" title="Seleccione el tema o asunto que va relacionado su solicitud. "></i></label>
                                                <div class="col-sm-12">
                                            ...
                                            <div class="form-group justify-content-md-center">
                                                <label class="col-sm-12 text-bold" for="asunto">Asunto</label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="asunto" name="asunto" placeholder="Ingrese el asunto del incidente" >
                                                    <div class="subjectvalidate error">
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script src="{{ asset('js/Reclamaciones/ayuda.js')}} "></script>
